  ...
  return [
    {
      ...
      content: [
        ...
        '- Before editing unusual phrasing, test whether it may be intentional craft (for example: zeugma/syllepsis, deliberate ambiguity, syntactic compression, rhythm friction, voice-driven fragmentation, rhetorical repetition, register shifts).',
        '- If a line is plausibly intentional and defensible in full context, preserve it. Prefer a comment over a rewrite, or omit the suggestion.',
        '- Do not normalize texture solely to make prose smoother when that would flatten voice, imagery, argument, rhythm, persona, or narrative intent.',
  ...
  return [
    {
      ...
      content: [
        ...
        '- Remove suggestions that flatten or erase plausible intentional craft choices unless they clearly fix a true error.',
        '- Preserve defensible author intent even when the style is unconventional or initially surprising.',
